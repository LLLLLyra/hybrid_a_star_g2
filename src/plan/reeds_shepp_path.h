...
/**
 * @brief ReedShepp curves with G1 continuity
 *
 */
class ReedShepp {
 public:
  ...
  /**
   * @brief Pick the shortest path from all possible combination of movement
   ...
   * @return false
   */
  virtual bool ShortestRSP(const std::shared_ptr<Node3d> start_node,
